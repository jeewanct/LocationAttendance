...
//  BluedolphinPro
//
//  Created by Raghvendra on 28/11/16.
...
// MARK: CustomNavigationDropdownMenu
open class CustomNavigationDropdownMenu: UIView {
    ...
    open var cellHeight: NSNumber! {
        get {
            ...
            //NSNumber(self.configuration.cellHeight)
        }
        set(value) {
    ...
    public init(navigationController: UINavigationController? = nil, containerView: UIView = UIApplication.shared.keyWindow!, title: String, items: [AnyObject]) {
        ...
        self.menuButton.addTarget(self, action: #selector(CustomNavigationDropdownMenu.menuButtonTapped(_:)), for: UIControlEvents.touchUpInside)
        ...
        let backgroundTapRecognizer = UITapGestureRecognizer(target: self, action: #selector(CustomNavigationDropdownMenu.hideMenu));
        ...
        self.tableView = DropDownTableView(frame: CGRect(x: menuWrapperBounds.origin.x, y: menuWrapperBounds.origin.y + 0.5, width: menuWrapperBounds.width, height: menuWrapperBounds.height + 300 - navBarHeight - statusBarHeight), items: items, title: title, configuration: self.configuration)
...
class NavConfiguration {
    ...
    func defaultValue() {
        ...
        //self.arrowTintColor = UIColor.black
        ...
        self.cellTextLabelFont = UIFont(name: "SourceSansPro-Regular", size: 17)
        self.navigationBarTitleFont = UIFont(name: "SourceSansPro-Regular", size: 17)
        self.cellTextLabelAlignment = NSTextAlignment.left
        self.cellSelectionColor = UIColor.lightGray
        self.checkMarkImage = UIImage(named: "checkmark")
        self.shouldKeepSelectedCellColor = false
        self.animationDuration = 0.5
        self.arrowImage = UIImage(named: "dropdown")
...
class DropDownTableView: UITableView, UITableViewDelegate, UITableViewDataSource {
    ...
    // Public properties
    var configuration: NavConfiguration!
    ...
    init(frame: CGRect, items: [AnyObject], title: String, configuration: NavConfiguration) {
...
class DropDownTableViewCell: UITableViewCell {
    ...
    init(style: UITableViewCellStyle, reuseIdentifier: String?, configuration: NavConfiguration) {
        ...
        if self.textLabel!.textAlignment == .center {
            ...
            self.checkmarkIcon = UIImageView(frame: CGRect(x: horizontalMargin, y: (cellContentFrame.height - 20)/2, width: 20, height: 20))
        }
        ...
        // Separator for cell
        let separator = TableCellContentView(frame: cellContentFrame)
...
class TableCellContentView: UIView {
