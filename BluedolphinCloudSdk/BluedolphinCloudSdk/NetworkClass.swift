...
public class NetworkModel: NSObject {
   public class func fetchData(_ strURL: String, success:@escaping (Any) -> Void, failure:@escaping (Error) -> Void) {
 ...
 public   class func submitData(_ strURL : String,method:HTTPMethod, params : [String : AnyObject]?, headers : [String : String]?, success:@escaping (NSDictionary) -> Void, failure:@escaping (Error) -> Void){
